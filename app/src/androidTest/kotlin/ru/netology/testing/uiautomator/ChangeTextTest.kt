...
class ChangeTextTest {
    ...
    private val textToSetOne = "Netology"
    private val textToSetTwo = "   "
...
//
    ...
    fun testChangeText() {
        ...
        device.findObject(By.res(packageName, "userInput")).text = textToSetOne
        device.findObject(By.res(packageName, "buttonChange")).click()

        val result = device.findObject(By.res(packageName, "textToBeChanged")).text
        assertEquals(result, textToSetOne)
    ...
    fun testNotChangeText() {
        ...
        val textToBe = device.findObject(By.res(packageName, "textToBeChanged")).text

        device.findObject(By.res(packageName, "userInput")).text = textToSetTwo
        device.findObject(By.res(packageName, "buttonChange")).click()

        val result = device.findObject(By.res(packageName, "textToBeChanged")).text
        assertEquals(result, textToBe)
